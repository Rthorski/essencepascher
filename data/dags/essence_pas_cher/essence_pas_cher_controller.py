...
from essence_pas_cher.essence_pas_cher_services import parseFile, create_dataframes
from essence_pas_cher.essence_pas_cher_load import load_tables_in_database
...
def load_to_database(**context):
  ti = context['ti']
  date_ti = context['ts']
  process_id = context['params']['process_id']
  ...
  load_tables_in_database(list_of_dict, date_ti, process_id)

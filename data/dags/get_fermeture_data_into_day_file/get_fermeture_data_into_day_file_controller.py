...
from essence_pas_cher.essence_pas_cher_load import get_entry_data, search_new_or_updated_rows, read_data_entry, get_table_to_dataframe, get_all_stations, rename_columns

rename_columns_gas_station_closures = {
  "type": "type",
  "debut": "start_closure",
  "fin": "end_closure",
...
def load_to_database(**context):
  ...
  df_entry_data.rename(columns=rename_columns_gas_station_closures, inplace=True)
